//copy from seed.js to get access to db
...
module.exports = {
    ...
    updateUserInfo: (req, res) => {
        let body = { firstName, lastName, phoneNumber, email, address, city, state, zipCode  } = req.body
    ...
    getUserAppt: (req, res) => {
        let query = `SELECT * FROM cc_appointments WHERE client_id = ${clientId}
        ORDER BY date desc`
